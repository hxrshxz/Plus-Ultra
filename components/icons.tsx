...
export const DumbbellIcon: React.FC<IconProps> = ({ className }) => (
  <svg
    ...
    className={className}
  >
    <path d="M4 7h2v10H4a2 2 0 01-2-2V9a2 2 0 012-2zm18 2v6a2 2 0 01-2 2h-2V7h2a2 2 0 012 2zM7 6h2v12H7V6zm8 0h2v12h-2V6zm-5 5h4v2h-4v-2z" />
  </svg>
);
...
export const ScaleIcon: React.FC<IconProps> = ({ className }) => (
  <svg
    ...
    className={className}
  >
    <path strokeLinecap="round" strokeLinejoin="round" d="M12 3v1.5M12 19.5V21M21 12h-1.5M4.5 12H3M18.364 5.636l-1.06 1.06M6.696 17.304l-1.06 1.06M18.364 18.364l-1.06-1.06M6.696 6.696l-1.06-1.06" />
